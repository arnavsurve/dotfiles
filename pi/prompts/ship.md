...
---
Look at all uncommitted changes (staged and unstaged). Group them into logical commits by related files/concerns — don't lump everything into one commit. For each logical group:
